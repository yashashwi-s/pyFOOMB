...
MODEL_TEMPLATES = {
    ...
    "monod_inhibition": {
        ...
        "equation": "µ = µ_max · S / (K_S + S + S²/K_I)",
        "states": ["P", "S", "X"],
        "state_labels": {"P": "Product", "S": "Substrate", "X": "Biomass"},
    ...
    "double_monod": {
        ...
        "equation": "µ = µ_max · S₁/(K_S1+S₁) · S₂/(K_S2+S₂)",
        "states": ["S1", "S2", "X"],
    ...
    "fed_batch_monod": {
        ...
        "equation": "µ = µ_max · S / (K_S + S), feed at t = t_feed",
        "states": ["S", "V", "X"],
